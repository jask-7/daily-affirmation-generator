...
class AffirmationGenerator:
    def __init__(self):
        self.categories = self.load_affirmations()
    ...
    def get_affirmation(self, category=None):
        if category:
            ...
            if not available_affirmations:
                ...
                available_affirmations = self.categories[category]
            ...
            available_affirmations = [a for a in all_affirmations if a not in displayed_all]
            if not available_affirmations:
                # Reset all categories if all affirmations have been shown
                self.displayed_affirmations = {category: [] for category in self.categories.keys()}
                available_affirmations = all_affirmations
            affirmation = random.choice(available_affirmations)
...
class AffirmationApp:
    ...
    def display_welcome_message(self):
        ...
        # Subtitle with rainbows instead of hearts
        st.markdown("#### 🌈 Embrace each day with love, gratitude, and an open heart. 🌈")
        st.markdown("#### 🌈 Let's uncover today's affirmation that speaks to your soul. 🌈")
        st.markdown("\n\n")
    ...
    def get_user_choice(self):
        return st.selectbox("Would you like a random affirmation or choose a category?", 
                            ["Random Affirmation", "Choose a Category"])

    def choose_category(self):
        categories = list(self.generator.categories.keys())
        return st.selectbox("Choose your affirmation category:", categories)
